  ...
  render() {
    if(!this.state.loadingScreen){
        return (
          <div className="App">
            <Switch>
              <Route exact path={routes.RESTURANT_LOGIN} component={LoginScreen}/>
              <Route path={routes.RESTURANT_SIGNUP} component={SignupScreen}/>
              <Route path={routes.RESTURANT_EMAIL_VERIFICATION} component={EmailVerificationScreen}/>
              ...
              <Route path={routes.RESTURANT_MESSAGING} component={MessagesScreen}/>
              <Route path={routes.RESTURANT_NOTIFICATIONS} component={NotificationsScreen}/>
              <Route path={routes.RESTURANT_FOODMENU} component={FoodMenuScreen}/>
