...
export const REDIRECT_TO = RESTURANT_OFFERS;

//Open Create Offer
export const OPEN_CREATE_OFFER_MODAL = "OPEN_CREATE_OFFER_MODAL";
export const CLOSE_CREATE_OFFER_MODAL = "CLOSE_CREATE_OFFER_MODAL";
