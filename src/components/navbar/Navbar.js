...
class Navbar extends Component{
    ...
    render(){
        return(
            <div id="navBarWrap" style={{
                position: 'fixed',
                top: '0',
                width: '100%',
                height: '50px',
                boxShadow: "0 0px 5px rgba(0,0,0,0.2), 0 0 40px rgba(0,0,0,0.1) inset",
                backgroundColor: '#fff',
            }}>
                <div style={{
                    height: '50px',
                    ...
                    <Link to={routes.RESTURANT_OFFERS}>
                        <div onClick={() => this.setActive(0)} style={this.navStyles}>
                            <NavButton isActive={this.state.active[0]} icon="fa fa-tags fa-lg" text=""/>
                        </div>
                    </Link>

                    <Link to={routes.RESTURANT_FOOD}>
                        <div onClick={() => this.setActive(1)} style={this.navStyles}>
                            <NavButton isActive={this.state.active[1]} icon="fa fa-cutlery fa-lg" text=""/>
                        </div>
                    </Link>

                    <Link to={routes.RESTURANT_BOOKING}>
                        <div onClick={() => this.setActive(2)} style={this.navStyles}>
                            <NavButton isActive={this.state.active[2]} icon="fa fa-bookmark fa-lg" text=""/>
                        </div>
                    </Link>

                    <Link to={routes.RESTURANT_MESSAGING}>
                        <div onClick={() => this.setActive(3)} style={this.navStyles}>
                            <NavButton isActive={this.state.active[3]} icon="fa fa-comment fa-lg" text=""/>
                        </div>
                    </Link>

                    <Link to={routes.RESTURANT_NOTIFICATIONS}>
                        <div onClick={() => this.setActive(4)} style={this.navStyles}>
                            <NavButton isActive={this.state.active[4]} icon="fa fa-bell fa-lg" text=""/>
                        </div>
                    </Link>

                    <Link to={routes.RESTURANT_FOODMENU}>
                        <div onClick={() => this.setActive(4)} style={this.navStyles}>
                            <NavButton isActive={this.state.active[5]} icon="fa fa-list-ul fa-lg" text=""/>
                        </div>
                    </Link>
