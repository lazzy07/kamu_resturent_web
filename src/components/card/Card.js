  ...
  openMessages = () => {
    if (this.props.comments) {
      ...
      let showMoreButton = (
        ...
        >
          <hr />
          <b onClick={this.openMessages}>
            <i className="fa fa-chevron-down" /> Show More Comments
          </b>
        </div>
      );
        ...
        if (lengthLeft > 0) {
          if (lengthLeft > increment) {
            comments = this.props.comments.slice(
              0,
              this.state.activeComments + increment
            );
  ...
  openLikes = () => {
    if (this.props.likes) {
      ...
      let showMoreButton = (
        ...
        >
          <hr />
          <b onClick={this.openLikes}>
            <i className="fa fa-chevron-down" /> Show More Likes
          </b>
        </div>
      );
      ...
      if (fullLength > increment) {
        ...
        if (lengthLeft > 0) {
          if (lengthLeft > increment) {
            likes = this.props.likes.slice(
              0,
              this.state.activeLikes + increment
            );
            button = showMoreButton;
          } else {
        ...
        description = (
          ...
          >
            ...
            <b
              onClick={() => {
                description = (
                  <p style={{ padding: "15px" }}>{this.props.description}</p>
                );
      ...
      <Animated className="fadeIn">
        ...
        >
          ...
          <div style={{ marginLeft: "15px" }}>
            <TimeAgo
              minPeriod={10}
              style={{ margin: "0px", color: "#7a7a7a", fontSize: "14px" }}
