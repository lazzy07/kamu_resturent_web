    ...
    render(){
        ...
        return(
            <form>
                ...
                <ImageButtonRender/>
                <div style={{paddingLeft: '25px', paddingRight: '10px', paddingTop: '5px'}} className="row">
                    <p style={{color: '#7a7a7a', fontSize: '14px'}}>Maximum file size is : {MAX_IMAGE_SIZE_CAN_UPLOAD}MB</p>
                </div>
                <div style={{paddingLeft: '10px', paddingRight: '10px', marginTop: '15px'}} className="row">
                    <div className="col-6 col-md-4">
                        <InputBox
                            description="Eg: 250"
                            inputStyles={{borderColor: "#7a7a7a",}}
                ...
                <div style={{paddingLeft: '10px', paddingRight: '10px', marginTop: '15px'}} className="row">
                    <div className="col-12 col-md-6">
                        ...
                        />
                        <span style={{color: '#7a7a7a', fontSize: '14px'}}>Enter tags so people can search your offer</span>
                    </div>
                </div>
                <div style={{color: '#7a7a7a', fontSize: '15px', textAlign: 'center', padding: '40px', fontWeight: 'bold'}}>
                    {this.state.mainMessage}
                </div>
                <div style={{display: 'flex', justifyContent: 'flex-end'}}>
                    <div style={{paddingRight: '10px'}}>
                    <Button text={this.state.buttonText} onClick={(e) => this.onSubmit(e)} normStyles={{backgroundColor: '#e8232d', borderColor: "#e8232d", color: '#fff', opacity: this.state.buttonOpacity}}/>
                    </div>
                    <Button 
                        onClick={() => {
...
export default connect(mapStateToProps, null)(CreateOfferForm);