...
class ImageButtonArray extends Component{
            ...
            buttonArray : [
                (
                    <div key={0} style={{marginTop: '10px'}} className="col-12 col-md-4">
                        <UploadPictureButton  removeButton={(id) => this.removeButton(id)} addNewButton={this.addNewButton} id={0}/>
                    </div>
                )
            ],
            id: 0,
    ...
    addNewButton = () => {
        let button = (
            <div key={this.state.id+1} style={{marginTop: '10px'}} className="col-12 col-md-4">
                <UploadPictureButton removeButton={(id) => this.removeButton(id)} addNewButton={this.addNewButton} id={this.state.id+1}/>
            </div>
        )
    ...
    render(){
        return(
            <div style={{paddingLeft: '10px', paddingRight: '10px', width: '100%'}} className="row">
...
export default connect(mapStateToProps, null)(ImageButtonArray);