  ...
  sendEmail = () => {
    ...
    authUser
      ...
      .catch(error => {
        ...
        this.setState({
          mainMessage: (
            <span style={this.descriptionStyles.warning}>{error.message}</span>
          )
        });
      });
  };
      ...
      if (!this.currentUser.emailVerified) {
          ...
          <div>
            ...
            >
              <div>
                ...
                >
                  <h1>
                    Kamu <span style={{ color: "#e8232d" }}>Resturant</span>
                  </h1>
                </div>
                <div style={{ textAlign: "center" }}>
                  <p style={{ color: "#7a7a7a" }}>
                    Please follow the link in the email we send you and refresh
                    this website
                    <br />
                  </p>
                </div>
        ...
        return (
          <div>
            ...
            >
              <div style={{ textAlign: "center" }}>
                <h1 style={{ color: "#7a7a7a" }}>Access Denied</h1>
              </div>
            </div>
          </div>
        );
